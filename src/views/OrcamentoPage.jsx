                ...
                <Box position="relative" mt={{ base: 4, md: 0 }}>
                    ...
                    <Flex position="relative" zIndex={1} direction="column" align="center" bg="rgba(255, 255, 255, 0.03)" backdropFilter="blur(10px)" border="1px solid rgba(255, 255, 255, 0.05)" borderRadius="3xl" p={{ base: 6, md: 12 }} boxShadow="0 8px 32px rgba(0, 0, 0, 0.1)" textAlign="center">
                        <Text fontSize={{ base: "sm", md: "xl" }} color="#e1d8ed" mb={6} lineHeight="1.8">
                            <span dangerouslySetInnerHTML={{ __html: t('orcamento.subtitle1') }}></span> <Text as="span" style={{ background: 'linear-gradient(to right, #d6bcfa, #90cdf4)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', fontWeight: 'bold' }}> Raynix4@gmail.com </Text>{t('orcamento.subtitle2')}
                        </Text>
                        ...
                        <ChakraButton
                            as="a"
                            href="mailto:raynix4@gmail.com?subject=Solicitação de orçamento - Desenvolvimento"
                            leftIcon={<FaEnvelope />}
                            size={{ base: "md", md: "lg" }}
                            color="white"
                            variant="solid"
